        ...
        <div id="backgroundsub">
            <div id="backgroundpatternsub">
                ...
                <div id="container">
                    ...
                    <?=form_open('index.php/usuarios/inserir')?>
                    ...
                    <label>Login:</label>
                    <input name="tx_login" id="tx_login" type="text" class="text-field" />

                    <br>
                    <br>

                    <label>Senha:</label>
                    <input name="tx_senha" id="tx_senha" type="password" class="text-field" />
