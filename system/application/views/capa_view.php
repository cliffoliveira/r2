...
<div id="container">
 ...
 <li id="kwick_1">
   <a href="http://aext.net/" >Home
       <h3>P&aacute;gina principal</h3>
  </a>
 </li>
 <li id="kwick_2">
   <a href="http://aext.net/category/css/">SCM
     <h3>Opere legalmente</h3>
  </a>
 </li>
 <li id="kwick_3">
     <a href="http://aext.net/category/java/">Servi&ccedil;os
     <h3>Consultoria</h3>
  </a>
 </li>
 <li id="kwick_4">
   <a href="http://aext.net/category/others">Parceiros
     <h3>Locais</h3>
  </a>
 </li>
 <li id="kwick_5">
   <a href="http://aext.net/category/php/">Cadastre-se
     <h3>Teste</h3>
  </a>
 </li>
 <li id="kwick_6">
   <a href="http://aext.net/category/resources/">Contato
     <h3>Fale conosco</h3>
  </a>
 </li>
 <li id="kwick_7">
   <a href="http://aext.net/category/theme-layout/">Login
